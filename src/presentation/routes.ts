...
import type { LinksController } from "./controllers/LinksController.js";
import type { AnonymousAccessController } from "./controllers/AnonymousAccessController.js";

export function buildRoutes(args: {
  linksController: LinksController;
  accessController: AnonymousAccessController;
}) {
