...
import type { CreateAnonymousLinkUseCase } from "../../application/usecases/CreateAnonymousLinkUseCase.js";
import type { DeleteAnonymousLinkUseCase } from "../../application/usecases/DeleteAnonymousLinkUseCase.js";

export class LinksController {
  constructor(
    private createUC: CreateAnonymousLinkUseCase,
    private deleteUC: DeleteAnonymousLinkUseCase
  ) {}
  ...
  createHtml = async (req: Request, res: Response) => {
    const { userId, ttlSeconds, targetUrl, note } = req.body ?? {};
    const out = await this.createUC.execute({
